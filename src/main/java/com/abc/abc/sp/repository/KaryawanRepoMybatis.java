...
public interface KaryawanRepoMybatis {
    ...
    @Select("select resid, resnama ,resjk, resdob, resalamat, resstatus from public.getkaryawanbyname(#{rqNama});")
    ...
    void insertProcedure(String inama, String ijk, Date idob, String ialamat, String istatus, int iid, String errorDesc, int errorCode);
